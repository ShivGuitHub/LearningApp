...
//    public static final String CONNECTION_PASSWORD = "eB4!bT2!";
    ...
    //Admin Table
    public static final String ADMIN_SUBJECTCONTAINER_TABLE = "CREATE TABLE SUBJECTCONTAINER(SUBJECTID SMALLINT PRIMARY KEY, SUBJECTNAME TEXT)";
    public static final String ADMIN_QUESTIONS_TABLE = "CREATE TABLE QUESTIONS(QUESTNO SMALLINT PRIMARY KEY,QUESTSUBJECT TEXT, QUESTANSWER MEDIUMTEXT, QUESTLIKE MEDIUMINT, QUESTDISLIKE MEDIUMINT)";
    public static final String ADMIN_QUESTIONSPREVIEWS_TABLE = "CREATE TABLE QUESTIONSPREVIEWS(QUESTNO SMALLINT PRIMARY KEY,QUESTSUBJECT TEXT, QUESTANSWER TEXT)";
